...
data = []
activitylist = [ActivityQueries.inboundPallets(), ActivityQueries.outPallets()]


def activity():
    # break the loop at a different intersection shoul call the loop after data is ran
    # loop should be the data frame cleaning not the data pulling

    for query in activitylist:
        ...
        df2 = df.drop(["402FULLERTON", "428FULLERTON", "137CERRITOS", "137FULLERTON",
                       "412CERRITOS", "415FULLERTON", "409FULLERTON", "403FULLERTON"])
